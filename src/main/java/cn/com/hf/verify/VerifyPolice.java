 ...
 */
@Component
public class VerifyPolice implements VerifyConfig {

	private Logger logger = LoggerFactory.getLogger(getClass());

	public static final String uri = "/VerifyPoliceServet";
	...
	public String verifyPoliceInformation(String accName, String certNo, String tradeTrace, String loginUserName) {
		String respMsg = StringUtils.EMPTY;

		if (StringUtils.isBlank(tradeTrace) || StringUtils.isBlank(certNo) || StringUtils.isBlank(accName))
			return respMsg;
		...
		try {
			...
			verifyTradeListDao.runPreservation(loginUserName, VerifyConfig.VERIFY_TYPE_Police, tradeTrace, map);
		} catch (Exception e) {
			logger.error("请求公安信息鉴权异常", e);
		}
