 ...
 */
@Component
public class BankVerify implements VerifyConfig {

	private Logger logger = LoggerFactory.getLogger(getClass());

	public static final String uri = "/VerifyBankServet";
	...
	public String verifyBankInformation(String accNo, String accName, String certNo, String mobileNo,
			String tradeTrace, String loginUserName) {
		String respMsg = StringUtils.EMPTY;

		if (StringUtils.isBlank(tradeTrace) || StringUtils.isBlank(accNo) || StringUtils.isBlank(accName))
			return respMsg;
		...
		map.put(VERIFY_NODE_accNo, accNo);
		map.put(VERIFY_NODE_accType, "01");
